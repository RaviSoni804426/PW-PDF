l10n.ru = {
    ...
    btnCreatePortal: 'Создать облако PW PDF',
    ...
    portalEmptyAdv1: 'Еще нет облачного аккаунта? Перейдите в онлайн-режим с облачным сервисом PW PDF и попробуйте возможности совместного редактирования бесплатно.',
    ...
    linkCreatePortal: 'Создать облако PW PDF',
    ...
    loginNoteAssignPhone: 'Для обеспечения повышенной безопасности в облаке PW PDF включена двухфакторная аутентификация. Для продолжения работы в облачном офисе введите ваш номер мобильного телефона. Номер мобильного телефона необходимо ввести в международном формате с кодом страны.',
    ...
    emptySlide3Text: 'Храните документы в облаке PW PDF и получайте к ним доступ в любое время, из любой точки мира.',
