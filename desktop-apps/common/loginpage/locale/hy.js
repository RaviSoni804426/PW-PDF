l10n.hy = {
    ...
    btnCreatePortal: 'Ստեղծել PW PDF ամպ',
    ...
    portalEmptyAdv1: 'Դեռևս չունե՞ք ամպային հաշիվ։ Դարձեք առցանց PW PDF ամպային ծառայության հետ և <br />անվճար փորձեք համագործակցային հնարավորությունները։',
    ...
    linkCreatePortal: 'Ստեղծել PW PDF ամպ',
    ...
    loginNoteAssignPhone: 'Երկու գործոնով վավերացումն միացված է, որպեսզի ապահովվի PW PDF ամպի լրացուցիչ անվտանգություն։ Մուտքագրեք Ձեր հեռախոսահամարը, որպեսզի շարունակեք աշխատել ամպային office-ում։ Հեռախոսահամարը պետք է մուտքագրվի երկրի կոդով՝ ըստ միջազգային ֆորմատի։',
    ...
    emptySlide3Text: 'Պահպանեք Ձեր փաստաթղթերը PW PDF ամպում, և դրանք հասանելի կլինի ցանկացած պահի ցանկացած վայրից։',
