l10n.no = {
    ...
    btnCreatePortal: 'Lag en PW PDF-sky',
    ...
    portalEmptyAdv1: 'Har du ikke konto enda? Koble deg til nettet med PW PDF skytjeneste og <br />prøv samarbeidsfunksjonene gratis.',
    ...
    linkCreatePortal: 'Sett opp en PW PDF-sky',
    ...
    loginNoteAssignPhone: 'To-faktor-godkjenning er aktivert for å gi ekstra skysikkerhet for PW PDF. Skriv inn mobilnummeret ditt for å fortsette å arbeide på skykontoret. Mobiltnummer må angis med et internasjonalt format med landskode.',
    ...
    emptySlide3Text: 'Lagre dokumentene dine i PW PDF-skyen og få tilgang til dem når som helst, fra hvor som helst.',
