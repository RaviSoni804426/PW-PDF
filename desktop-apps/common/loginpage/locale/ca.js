l10n.ca = {
    ...
    btnCreatePortal: 'Crea un núvol PW PDF',
    ...
    portalEmptyAdv1: 'Encara no tens un compte de núvol? Entra en línia amb PW PDF Cloud Service i<br />prova les capacitats col·laboratives de franc.',
    ...
    linkCreatePortal: 'Crea un núvol PW PDF',
    ...
    loginNoteAssignPhone: 'L\'autenticació de dos factors està habilitada per proporcionar seguretat addicional al núvol de PW PDF. Introduïu el número de telèfon mòbil per continuar treballant a l\'oficina del núvol. Cal introduir el número de telèfon mòbil mitjançant un format internacional amb codi de país.',
    ...
    emptySlide3Text: 'Emmagatzema els teus documents al núvol PW PDF i accedeix-hi en qualsevol moment, des de qualsevol lloc.',
