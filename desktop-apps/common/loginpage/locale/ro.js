l10n.ro = {
    ...
    btnCreatePortal: 'Crearea unui cont PW PDF cloud',
    ...
    portalEmptyAdv1: 'Încã nu aveți un cont Cloud? Lucrați online cu servicii cloud PW PDF ți <br />încercați funcțiile de colaborare gratuit.',
    ...
    linkCreatePortal: 'Crearea unui cont PW PDF cloud',
    ...
    loginNoteAssignPhone: 'Autentificarea cu doi factori este activatã ca o mãsurã suplimentarã de securitate pentru PW PDF cloud. Intra-i numãrul de telefon dvs vă sã puteţi continua lucrul în oficiul cloud. Numãrul de telefon mobil trebuie introdus în format internaþional cu prefixul de țarã.',
    ...
    emptySlide3Text: 'Stocați-vă documentele în PW PDF cloud și le accesati de oriunde, oricând.',
