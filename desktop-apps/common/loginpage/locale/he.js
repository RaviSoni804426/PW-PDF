l10n.he = {
    ...
    btnCreatePortal: 'צור ענן PW PDF',
    ...
    portalEmptyAdv1: 'עדיין אין לך חשבון ענן? עבור למצב מקוון עם PW PDF Cloud Service ו- <br />נסה יכולות שיתוף פעולה בחינם.',
    ...
    linkCreatePortal: 'צור ענן PW PDF',
    ...
    loginNoteAssignPhone: 'האימות הדו-שלבי מופעל כדי לספק אבטחת ענן נוספת של PW PDF. הזן את מספר הטלפון הנייד שלך כדי להמשיך לעבוד במשרד הענן. יש להזין את מספר הטלפון הנייד בפורמט בינלאומי עם קידומת מדינה.',
    ...
    emptySlide3Text: 'אחסן את המסמכים שלך בענן PW PDF וגש אליהם בכל עת ומכל מקום.',
