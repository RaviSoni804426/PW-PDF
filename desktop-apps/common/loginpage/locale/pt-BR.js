l10n.pt_BR = {
    ...
    btnCreatePortal: 'Criar PW PDF na nuvem',
    ...
    portalEmptyAdv1: 'Ainda não tem uma conta? Experimente colaboracão na nuvem do PW PDF gratuitamente.',
    ...
    linkCreatePortal: 'Criar PW PDF na nuvem',
    ...
    loginNoteAssignPhone: 'A autenticação de dois fatores está habilitada para fornecer segurança adicional ao nuvem do PW PDF. Insira o seu número de celular para continuar trabalhando no escritório na nuvem. O número de telefone deve ser inserido usando um formato internacional com o código do país.',
    ...
    emptySlide3Text: 'Armazene seus documentos na nuvem do PW PDF e acesse-os a qualquer momento, de qualquer lugar.',
