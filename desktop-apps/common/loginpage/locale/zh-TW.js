l10n.zh_TW = {
    ...
    portalEmptyAdv1: '還沒有雲端帳號嗎？與 PW PDF 雲端服務一起上線 <br />免費試用多種共同作業功能',
    ...
    pshPhone: '電話號碼',
    pshCode: '簡訊驗證碼',
    loginNoteAssignPhone: '為加強 PW PDF 雲端的安全性，已啟用雙因素驗證。請輸入您的手機號碼以繼續在雲端 office 上工作。手機號碼必須以加上國碼的國際格式輸入。',
    ...
    emptySlide3Text: '將您的文件儲存於 PW PDF 雲端，並隨時、隨處輕鬆存取文件。',
    settUserName: '使用者名稱',
