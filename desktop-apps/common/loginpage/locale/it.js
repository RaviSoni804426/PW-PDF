l10n.it_IT = {
    ...
    btnCreatePortal: 'Crea PW PDF cloud',
    ...
    portalEmptyAdv1: 'Non hai ancora un account cloud? Vai online con PW PDF Cloud Service e prova le capacità di collaborazione gratis.',
    ...
    linkCreatePortal: 'Crea PW PDF cloud',
    ...
    loginNoteAssignPhone: 'L\'autenticazione a due fattori è abilitata per fornire ulteriore sicurezza del PW PDF cloud. Inserisci il tuo numero di cellulare per continuare a lavorare sul ufficio cloud. Il numero di cellulare deve essere inserito utilizzando un formato internazionale con prefisso internazionale.',
    ...
    emptySlide3Text: 'Archivia i tuoi documenti nel cloud PW PDF e accedili in qualsiasi momento da qualsiasi luogo.',
