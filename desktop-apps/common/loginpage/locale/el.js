l10n.el = {
    ...
    btnCreatePortal: 'Δημιουργήστε ένα PW PDF cloud',
    ...
    portalEmptyAdv1: 'Δεν έχετε λογαριασμό cloud; Συνδεθείτε στο διαδίκτυο με την υπηρεσία PW PDF Cloud και <br /> δοκιμάστε τις δυνατότητες συνεργασίας δωρεάν.',
    ...
    linkCreatePortal: 'Δημιουργία ενός PW PDF cloud',
    ...
    emptySlide3Text: 'Αποθηκεύστε τα έγγραφά σας στο PW PDF cloud και αποκτήστε πρόσβαση σε αυτά ανά πάσα στιγμή και από οπουδήποτε.',
