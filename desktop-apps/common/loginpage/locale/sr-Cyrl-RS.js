l10n.sr_Cyrl_RS = {
    ...
    btnCreatePortal: 'Креирај PW PDF облак',
    ...
    portalEmptyAdv1: 'Још увек немате облак рачун? Идите онлајн са PW PDF Облак сервисом и <br /> покушајте сарађивачке способности бесплатно.',
    ...
    linkCreatePortal: 'Креирај PW PDF облак',
    ...
    loginNoteAssignPhone: 'Двофакторска аутентикација је омогућена да обезбеди додатну PW PDF облак безбедност. Унесите свој број телефона да наставите рад на облак офис-у. Број мобилног телефона мора бити унет користећи интернационални формат са кодом државе.',
    ...
    emptySlide3Text: 'Складишти своје документе у PW PDF облаку и приступи им било када, са било ког места.',
