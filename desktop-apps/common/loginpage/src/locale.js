...
l10n.en = {
    ...
    btnCreatePortal: 'Create an PW PDF cloud',
    ...
    portalEmptyAdv1: 'Don\'t have a cloud account yet? Go online with PW PDF Cloud Service and <br />try collaborative capabilities for free.',
    ...
    linkCreatePortal: 'Create an PW PDF cloud',
    ...
    loginNoteAssignPhone: 'The two-factor authentication is enabled to provide additional PW PDF cloud security. Enter your mobile phone number to continue work on the cloud office. Mobile phone number must be entered using an international format with country code.',
    ...
    emptySlide3Text: 'Store your documents in the PW PDF cloud and access them any time, from anywhere.',
