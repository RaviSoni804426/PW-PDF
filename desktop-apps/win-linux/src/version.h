...
#define VER_COMPANYNAME_STR         "Physics Wallah\0"
#define VER_LEGALCOPYRIGHT_STR      "© Physics Wallah " TO_STR(COPYRIGHT_YEAR) ". Based on ONLYOFFICE © Ascensio System SIA.\0"
#define VER_COMPANYDOMAIN_STR       "pw.live\0"
#define ABOUT_COPYRIGHT_STR         VER_LEGALCOPYRIGHT_STR
#define VER_FILEDESCRIPTION_STR     "PW PDF - PDF Editor\0"
#define VER_INTERNALNAME_STR        "PWPDF\0"
